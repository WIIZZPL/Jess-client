...
public class Knight extends ChessPiece{
    public Knight(int row, int column, boolean isPlayer,  boolean isWhite, Pane checkerBoard, LinkedList<ChessPiece> pieces) {
        super(row, column, isPlayer, isWhite, "knight", checkerBoard, pieces);
    }
